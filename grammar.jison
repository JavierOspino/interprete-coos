...
<<EOF>>				return 'EOF';
.					{ throw console.error('Este es un error léxico: ' + yytext + ', en la linea: ' + yylloc.first_line + ', en la columna: ' + yylloc.first_column); }
...
Sentence
    ...
    | TIF TASSIGN '(' Logical_Expression ')' '{' ListSentences '}' TELSE TASSIGN '{' ListSentences '}' ';'
    	| error { throw console.error('Este es un error sintáctico: ' + yytext + ', en la linea: ' + this._$.first_line + ', en la columna: ' + this._$.first_column); }
    ;
